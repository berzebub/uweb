<template>
  <div>
    <q-page>
      ...
      <sorry-duplicate
        v-show="exportingSelected.label == importingSelected.label"
      ></sorry-duplicate>

      <div
        v-show="isWaiting && exportingSelected.label != importingSelected.label"
      >
        <data-waiting
          :text="
            activeSelect == 1
