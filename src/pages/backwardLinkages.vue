      ...
      <div class="row">
        ...
        <div class="col" style="background-color:#E5E1E1;padding:80px 0px">
          ...
          <div align="center" class="q-px-lg">
            <p
              align="center"
            >Some part of {{ exportingSelected.label }}’s gross exports consist of imported inputs that originate in other source economies.</p>
    ...
    async setStackChart() {
      ...
      Highcharts.chart(
        "container1",
        {
          ...
          tooltip: {
            // pointFormat:
            //   "{series.name}: {point.y}<br/>Total: {point.stackTotal}<br/>testxxx",
